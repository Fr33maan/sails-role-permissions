        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.delegateYield(regeneratorRuntime.mark(function _callee() {
              var controller, action, isBlueprint, msg, filters, isOwner, _msg;
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 13:
                      ...
                      filters = (0, _attributeUtil.attributesFilter)(req, config);
                    ...
                    case 33:
                      if (!(action === 'add' || action === 'populate' || action === 'remove')) {
                        _context.next = 39;
                        break;
                      }
